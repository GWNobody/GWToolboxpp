**Salvify** is a plugin for [GWToolbox](https://github.com/gwdevhub/GWToolboxpp) for identifying and salvaging items in *Guild Wars*. The main feature provides a button and with just one click it will:
